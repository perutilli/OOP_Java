...
public class Order implements Comparable<Order>{
	...
	public String toString() {
		...
		res.append(this.restaurant.getName()).append(", ").append(this.user.toString()).
			append(" : (").append(this.delTime).append("):\n");
	...
	public int compareTo(Order o) {
		int comp = (this.user.compareTo(o.user));
		if (comp == 0) {
			comp = this.delTime.compareTo(o.delTime);
		}
		return comp;
	}
